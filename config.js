...
global.no = '120363157897656500@g.us';
...
//—————「 Set Nama Bot & Own 」—————//
global.namabot = 'LANZZ-𝙼𝙳'
global.namaowner = 'Muhamad Fadhlan'

//—————「 Setting Owner 」—————//
global.owner = ['6281311268263']
global.ownernomer = "6281311268263"
global.premium = ['6281311268263']
global.ultah = 'September 24, 2023'

//—————「 Setting Donasi 」—————//
global.dana = '085163600034'

//—————「 Set Kebutuhan Button 」—————//
global.email = 'fadhlanmhmd24@gmail.com'
global.namaweb = 'TikTok'
global.myweb = 'https://tiktok.com/@xyzinsom'
global.region = 'Indonesia'
global.github = 'https://github.com/xyzinsom'
global.mygc = 'https://chat.whatsapp.com/JgEbKEY7kfz8qclCYSNbEt'
global.myig = 'https://instagram.com/lanzzstoreofc'

//—————「 Set Wm 」—————//
global.packname = '𝚂𝚃𝙸𝙲𝙺𝙴𝚁 𝙱𝚈 LANNZ BOT MD\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n'
...
global.thumb = fs.readFileSync('./media/image/lanzz.jpg')
global.kurome = { url: 'https://a.uguu.se/faLPPBPP.mp4' }
global.botname = 'Lanzz Bot'
global.akulaku = 'Bot By Lanzz'
global.ttname = 'TikTok Xyz Insom'
